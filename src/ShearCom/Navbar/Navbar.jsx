...
import ThemeToggle from '../../Components/Light/ThemeToggle';
...
const message = new SpeechSynthesisUtterance("Thank You Sir , come again");

// Get available voices
const voices = window.speechSynthesis.getVoices();

// Pick a female voice (choose the most natural one available)
const femaleVoice = voices.find(
  (voice) =>
    voice.name.toLowerCase().includes("female") ||
    voice.name.toLowerCase().includes("zira") // Example for Windows
);
...
message.rate = 0.9;    // slightly slower for calmness
message.pitch = 1.3;   // a gentle, pleasant pitch
